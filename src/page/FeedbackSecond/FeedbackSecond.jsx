  ...
  return (
    ...
    <div className="w-full max-w-3xl bg-white p-6 rounded-lg shadow-lg">
      <h2 className="text-lg font-bold text-center mb-6">
        Thank you for joining our Pod Love! Your feedback is crucial in helping us improve the PodLove experience for you and others. Please take a few moments to share your thoughts.
      </h2>
      <Form layout="vertical" form={form} onFinish={onFinish}>
        <h3 className="font-semibold">1. Overall Connection</h3>
        <Form.Item
        ...
        <Form.Item label="Do you have any suggestions for improving the matching process or date experience?" name="suggestions">
          <Input.TextArea placeholder="Write here" rows={3} />
        </Form.Item>
        <Form.Item
        ...
        <Form.Item label="In your opinion, what factors influenced the level of chemistry you experienced?" name="chemistryFactors">
          <Input.TextArea placeholder="Write here" rows={3} />
        </Form.Item>
        ...
        <Form.Item label="Were there any awkward or uncomfortable moments? If so, please describe." name="awkwardMoments">
          <Input.TextArea placeholder="Write here" rows={3} />
        </Form.Item>

        <Form.Item className="flex justify-center">
          <AuthButton type="primary" htmlType="submit" className="bg-orange-400 px-6 py-2 rounded-md">
            Next
          </AuthButton>
        </Form.Item>
      </Form>
