    ...
    <div className="bg-[#FBECE5] min-h-screen">
      <div className="container max-w-5xl mx-auto py-10">
        ...
        <Form layout="vertical">
          ...
          <Form.Item
            label={
              <p className="font-medium font-poppins text-xl">Do you smoke?</p>
            }
          >
          ...
          <Form.Item
            label={
              <p className="font-medium font-poppins text-xl">
                Would you be comfortable dating someone who drinks?
              </p>
            }
          >
            <Radio.Group>
          ...
          <Form.Item
            label={
              <p className="font-medium font-poppins text-xl">
                Would you date someone with different religious or spiritual
                beliefs?
              </p>
            }
          >
          ...
          <div className="text-center">
            <Link to={"/rating-yourself"}>
              <AuthButton className={"max-w-80 py-2"}>Submit</AuthButton>
            </Link>
          </div>
        </Form>
      </div>
