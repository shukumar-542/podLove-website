  ...
  const onFinish = (values) => {
    const dataToSend = {
      ...
      responses: [
        {
          question:
            "How well did your match align with your interests, values, and relationship goals?",
          answer: values.matchAlignment,
        },
        {
          question: "How would you rate the flow of the conversation?",
          answer: values.conversationFlow,
        },
        {
          question: "Did you feel comfortable being yourself?",
          answer: values.comfortableBeingYourself,
        },
        {
          question: "Did you feel an initial spark or connection?",
          answer: values.initialSpark,
        },
        {
          question: "What factors influenced your connection most?",
          answer: values.factors,
        },
      ],
    };
      ...
      <div className="md:px-12 py-6">
        <div className="text-center mb-8 ">
          <h1 className=" text-2xl md:text-3xl font-semibold mb-3">
            Let us know about your first podcast
          </h1>
          <p className="text-lg">
            We&apos;d love to hear about your experience with your first
            podcast!
          </p>
        </div>
        <ConfigProvider
        ...
        >
          ...
          >
            ...
            <Form.Item
              name="matchAlignment"
              rules={[
                { required: true, message: "Please rate the alignment!" },
              ]}
              ...
              rules={[
                {
                  validator: (_, value) =>
                    value && value.length === 2
                      ? Promise.resolve()
                      : Promise.reject(
                          new Error("Please select exactly 2 factors!")
                        ),
                },
              ]}
            ...
            >
              ...
              >
                <div className="space-y-2">
                  ...
                  <Checkbox value="Communication Style">
                    Communication Style
                  </Checkbox>
                </div>
              </Checkbox.Group>
