...
const After7DaysSurveyModal = ({ is7DaysModalOpen, handle7DaysOk, handle7DaysCancel, podcastId }) => {
    ...
    const onFinish = (values) => {
        const dataToSend = {
            responses: [
                { question: 'How easy was it to navigate the PodLove app?', answer: values.first },
                { question: 'Did you experience any technical issues (scheduling, chat, notifications)?', answer: values.second },
                { question: 'How satisfied are you with your overall experience so far?', answer: values.third },
                { question: 'Do you have any suggestions to improve matching or the app experience?', answer: values.fourth },
            ],
        };
                ...
                <div className="md:max-w-3xl md:p-8 font-poppins">
                    ...
                    <Form form={form} onFinish={onFinish} layout="vertical" >
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, message: "Please write how to improve matching or the app experience!" }]}
                        >
                            <Input.TextArea
                                rows={4}
