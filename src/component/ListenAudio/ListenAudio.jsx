            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mx-auto mb-10">
                ...
                {isLoading ? (
                    ...
                    Array.from({ length: 3 }).map((_, index) => (
                        <div key={index} className="border border-[#FFA175] mx-auto w-full p-10 rounded-md animate-pulse">
                    ...
                    data?.data?.map((videoItem) => (
                        <div key={videoItem._id} className="border border-[#FFA175] mx-auto p-2 rounded-md">
