    ...
    >
      <div className="container mx-auto h-full flex items-center justify-between px-4 md:px-8">
        ...
        <div className="hidden lg:flex space-x-3 xl:space-x-8">
          {logInUser && (
            <NavLink to="/home" className="hover:text-[#FFA175]">
              Home
            </NavLink>
          )}
          {!logInUser && (
            <NavLink to="/" className="hover:text-[#FFA175]">
              Home
            </NavLink>
          )}
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed top-0 left-0 w-full h-full bg-white z-50 flex flex-col items-center justify-center transform ${
